...
export const SYLLABI = [
    ...
    { id: 24, name: "クラフトワーク特論", quarter: "2Q", day: "金", period: "7限", module: "応用・実践", type: "選択必修（E系）", credits: 1, capacity: 80, instructor: "吉田 知史", keywords: ["デジタルファブリケーション", "ものづくり", "手工芸", "プロトタイピング"], desc: "旧来の手工芸的なものづくりとデジタルファブリケーション技術による今日的なものづくりを学ぶ。", delivery: "対面+遠隔" },
    ...
    { id: 27, name: "スペキュラティブデザイン特論", quarter: "2Q", day: "金", period: "8限", module: "応用・実践", type: "選択必修（E系）", credits: 1, capacity: 25, instructor: "長谷川 敦士", keywords: ["スペキュラティブデザイン", "未来洞察", "シナリオプランニング"], desc: "スペキュラティブデザインの手法を通じて、未来のビジョンを批判的に思考する力を養う。", delivery: "遠隔" },
    { id: 28, name: "基礎造形", quarter: "2Q", day: "金", period: "8限", module: "基礎・理論", type: "選択", credits: 1, capacity: 25, instructor: "南雲 治嘉", keywords: ["造形", "色彩", "構成", "デザイン基礎"], desc: "デザインの基礎となる造形力を体系的に学ぶ。", delivery: "対面" },

    // ===== 夏季集中 =====
    { id: 29, name: "特別講義A", quarter: "夏季集中", day: "集中", period: "-", module: "応用・実践", type: "選択", credits: 1, capacity: 80, instructor: "特別講師", keywords: ["特別講義"], desc: "夏季集中形式の特別講義。外部講師を招聘し特定テーマを深く学ぶ。", delivery: "集中" },
    { id: 30, name: "クリエイティブコンピュテーション", quarter: "夏季集中", day: "集中", period: "-", module: "応用・実践", type: "選択必修（E系）", credits: 1, capacity: 25, instructor: "特別講師", keywords: ["クリエイティブコーディング", "プログラミング", "アート"], desc: "プログラミングを用いたクリエイティブ表現の実践。", delivery: "集中" },
    { id: 31, name: "ウェブ解析実践", quarter: "夏季集中", day: "集中", period: "-", module: "応用・実践", type: "選択必修（E系）", credits: 1, capacity: 80, instructor: "特別講師", keywords: ["ウェブ解析", "アクセス解析", "データ分析"], desc: "ウェブサイトのアクセス解析の基礎から実践まで。", delivery: "集中" },
    { id: 32, name: "特別講義L", quarter: "夏季集中", day: "集中", period: "-", module: "応用・実践", type: "選択", credits: 1, capacity: 80, instructor: "特別講師", keywords: ["特別講義"], desc: "夏季集中形式の特別講義。", delivery: "集中" },
    { id: 33, name: "プロダクトプロトタイピングA", quarter: "夏季集中", day: "集中", period: "-", module: "応用・実践", type: "選択必修（E系）", credits: 1, capacity: 25, instructor: "特別講師", keywords: ["プロトタイピング", "プロダクト開発"], desc: "プロダクト開発のプロトタイピング手法を実践的に学ぶ。", delivery: "集中" },

    // ===== 3Q =====
    { id: 34, name: "デジタル表現基礎B", quarter: "3Q", day: "月", period: "7限", module: "基礎・理論", type: "選択", credits: 1, capacity: 25, instructor: "石川 大樹", keywords: ["eラーニング", "クリエイティブツール", "自己調整学習"], desc: "デジタル表現基礎Aの発展編。より高度なクリエイティブツールを動画教材で学ぶ。", delivery: "遠隔" },
    { id: 35, name: "エマージングテクノロジー", quarter: "3Q", day: "月", period: "7限", module: "基礎・理論", type: "選択", credits: 1, capacity: 80, instructor: "安藤 幸央", keywords: ["新興技術", "テクノロジートレンド", "イノベーション"], desc: "新興テクノロジーの動向と社会への影響を学ぶ。", delivery: "遠隔" },
    { id: 36, name: "特別講義T", quarter: "3Q", day: "月", period: "8限", module: "応用・実践", type: "選択", credits: 1, capacity: 80, instructor: "特別講師", keywords: ["特別講義", "テクノロジー"], desc: "テクノロジー分野の特別講義。", delivery: "対面+遠隔" },
    { id: 37, name: "先端芸術原論", quarter: "3Q", day: "水", period: "7限", module: "基礎・理論", type: "選択", credits: 1, capacity: 80, instructor: "特別講師", keywords: ["メディアアート", "デジタルアート", "芸術理論"], desc: "先端的な芸術表現の理論と実践を学ぶ。", delivery: "対面" },
    { id: 38, name: "知的財産活用実践", quarter: "3Q", day: "水", period: "7限", module: "応用・実践", type: "選択", credits: 1, capacity: 80, instructor: "高瀬 亜富", keywords: ["知的財産", "著作権活用", "ライセンス"], desc: "1Qの知的財産原論の発展。知的財産の実践的活用方法を学ぶ。", delivery: "遠隔" },
    ...
    { id: 40, name: "先端コンピュータグラフィックス原論", quarter: "3Q", day: "水", period: "8限", module: "基礎・理論", type: "選択", credits: 1, capacity: 80, instructor: "西田 友是", keywords: ["CG", "コンピュータグラフィックス", "レンダリング", "3DCG"], desc: "先端的なコンピュータグラフィックスの理論と応用を学ぶ。", delivery: "遠隔" },
    ...
    { id: 42, name: "メディアアート特論", quarter: "3Q", day: "金", period: "7限", module: "応用・実践", type: "選択必修（D系）", credits: 1, capacity: 80, instructor: "特別講師", keywords: ["メディアアート", "インスタレーション", "デジタルアート"], desc: "メディアアートの理論と制作実践を深く学ぶ。", delivery: "対面" },
    ...
    { id: 44, name: "ストーリーテリング", quarter: "3Q", day: "金", period: "7限", module: "応用・実践", type: "選択必修（D系）", credits: 1, capacity: 80, instructor: "特別講師", keywords: ["ストーリーテリング", "ナラティブ", "脚本", "構成"], desc: "効果的なストーリーテリングの手法と構造を学ぶ。", delivery: "遠隔" },
    { id: 45, name: "デザインエンジニアリング", quarter: "3Q", day: "金", period: "8限", module: "応用・実践", type: "選択必修（E系）", credits: 1, capacity: 25, instructor: "特別講師", keywords: ["デザイン", "エンジニアリング", "プロトタイピング"], desc: "デザインとエンジニアリングを横断する実践的な開発手法を学ぶ。", delivery: "対面" },

    // ===== 4Q =====
    { id: 46, name: "ロボットデザイン", quarter: "4Q", day: "月", period: "7限", module: "応用・実践", type: "選択必修（E系）", credits: 1, capacity: 25, instructor: "特別講師", keywords: ["ロボット", "インタラクション", "デザイン", "AI"], desc: "ロボットのデザインとインタラクション設計を学ぶ。", delivery: "対面" },
    { id: 47, name: "先端マーケティング特論", quarter: "4Q", day: "月", period: "8限", module: "応用・実践", type: "選択必修（D系）", credits: 1, capacity: 80, instructor: "特別講師", keywords: ["マーケティング", "ブランディング", "戦略"], desc: "先端的なマーケティング手法と戦略を深く学ぶ。", delivery: "対面" },
    { id: 48, name: "コンテンツデザインA", quarter: "4Q", day: "水", period: "7限", module: "応用・実践", type: "選択必修（D系）", credits: 1, capacity: 80, instructor: "特別講師", keywords: ["コンテンツ", "デザイン", "企画", "制作"], desc: "コンテンツのデザインと企画制作を実践的に学ぶ。", delivery: "対面+遠隔" },
    ...
    { id: 50, name: "テクノロジー特論B（データ）", quarter: "4Q", day: "金", period: "7限", module: "応用・実践", type: "選択必修（E系）", credits: 1, capacity: 80, instructor: "特別講師", keywords: ["データ", "分析", "AI", "機械学習"], desc: "データを活用した応用技術を実践的に学ぶ。", delivery: "遠隔" },
    ...
    { id: 52, name: "テクノロジー特論C", quarter: "4Q", day: "金", period: "7限", module: "応用・実践", type: "選択必修（E系）", credits: 1, capacity: 80, instructor: "三宅 陽一郎", keywords: ["AI", "ゲーム", "インタラクション"], desc: "テクノロジー分野の応用的な特論。最新技術とその活用を学ぶ。", delivery: "対面" },
    ...
    { id: 54, name: "サービスプロトタイピングB", quarter: "4Q", day: "金", period: "8限", module: "応用・実践", type: "選択必修（E系）", credits: 1, capacity: 25, instructor: "山崎 大助", keywords: ["Webアプリケーション", "プロトタイピング", "API"], desc: "サービスプロトタイピングAの発展編。より高度なWebアプリケーション開発を実践。", delivery: "遠隔" },

    // ===== 通年（修了課題・ラボプロジェクト） =====
    { id: 55, name: "修了課題構想", quarter: "通年", day: "-", period: "-", module: "研究", type: "必修", credits: 2, capacity: null, instructor: "指導教員", keywords: ["修了課題", "研究構想", "テーマ設定"], desc: "修士課程の集大成となる修了課題の構想を行う。研究テーマの設定と計画立案。", delivery: "個別指導" },
    { id: 56, name: "修了課題計画", quarter: "通年", day: "-", period: "-", module: "研究", type: "必修", credits: 2, capacity: null, instructor: "指導教員", keywords: ["修了課題", "研究計画", "中間発表"], desc: "修了課題の計画を具体化し、中間発表を行う。", delivery: "個別指導" },
