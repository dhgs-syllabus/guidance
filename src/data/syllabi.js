...
const STATIC_SYLLABI = [
    ...
    { id: 50, name: "テクノロジー特論B（データ）", quarter: "4Q", day: "水", period: "7限", module: "応用・実践", type: "選択必修（E系）", credits: 1, capacity: 80, instructor: "特別講師", keywords: ["データ", "分析", "AI", "機械学習"], desc: "データを活用した応用技術を実践的に学ぶ。", delivery: "対面" },
    ...
    { id: 52, name: "テクノロジー特論C", quarter: "4Q", day: "金", period: "78限", module: "応用・実践", type: "選択必修（E系）", credits: 1, capacity: 80, instructor: "三宅 陽一郎", keywords: ["AI", "ゲーム", "インタラクション"], desc: "テクノロジー分野の応用的な特論。最新技術とその活用を学ぶ。", delivery: "遠隔" },
    { id: 53, name: "テクノロジー特論D（人工現実）", quarter: "4Q", day: "金", period: "8限", module: "応用・実践", type: "選択必修（E系）", credits: 1, capacity: 80, instructor: "白井 暁彦", keywords: ["VR", "AR", "MR", "XR", "人工現実"], desc: "VR/AR/MR/XRを中心とした人工現実技術の理論と応用。", delivery: "遠隔" },
